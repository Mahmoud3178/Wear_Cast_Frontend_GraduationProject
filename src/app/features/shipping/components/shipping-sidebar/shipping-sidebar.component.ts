    ...
    <div class="sidebar h-100 d-flex flex-column" [class.collapsed]="isCollapsed">
      ...
      <div class="sidebar-header p-4 d-flex align-items-center gap-3">
        ...
        <div class="brand-text" *ngIf="!isCollapsed">
          ...
          <span class="text-primary fw-medium text-xs text-uppercase tracking-wider">Shipping Manager</span>
        </div>
      </div>
      ...
      <nav class="sidebar-nav flex-grow-1 px-3 py-2 custom-scrollbar">
          ...
          <ul class="nav nav-pills flex-column gap-1">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-3 px-3 py-2.5 rounded-3 transition-all" 
                ...
                <span class="fw-medium text-nowrap" *ngIf="!isCollapsed">Managed Shipments</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-3 px-3 py-2.5 rounded-3 transition-all" 
                 routerLink="drivers" routerLinkActive="active" [title]="isCollapsed ? 'Drivers' : ''">
                <div class="icon-wrapper d-flex align-items-center justify-content-center">
        ...
        <div class="nav-section mb-4">
          ...
          <ul class="nav nav-pills flex-column gap-1">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-3 px-3 py-2.5 rounded-3 transition-all" 
                 routerLink="profile" routerLinkActive="active" [title]="isCollapsed ? 'Company Profile' : ''">
                <div class="icon-wrapper d-flex align-items-center justify-content-center">
                  <i class="bi bi-building-fill"></i>
                </div>
                <span class="fw-medium text-nowrap" *ngIf="!isCollapsed">Company Profile</span>
              </a>
            </li>
